...
const OrderDetail = () => {
    ...
    return (
        <div>
            <div className="py-5">
                <h1 className="text-xl text-pink-600 font-bold">All Orders</h1>
            </div>
                    ...
                    <tbody>
                        ...
                        {getAllOrder.map((order, orderIndex) => (
                            order.cartItems.map((item, itemIndex) => {
                                ...
                                return (
                                    <tr key={`${order.id}-${item.id}`} className="text-pink-600">
                                        <td className="h-12 px-6 text-md border-t border-l first:border-l-0 border-slate-300 text-slate-800">{orderIndex + 1}.{itemIndex + 1}</td>
                                        <td className="h-12 px-6 text-md border-t border-l first:border-l-0 border-slate-300 text-slate-800">{id}</td>
                                        <td className="h-12 px-6 text-md border-t border-l first:border-l-0 border-slate-300 text-slate-800"><img src={productImageUrl} alt="Product" /></td>
                                        <td className="h-12 px-6 text-md border-t border-l first:border-l-0 border-slate-300 text-slate-800">{title}</td>
                                        <td className="h-12 px-6 text-md border-t border-l first:border-l-0 border-slate-300 text-slate-800">{category}</td>
                                        <td className="h-12 px-6 text-md border-t border-l first:border-l-0 border-slate-300 text-slate-800">₹{price}</td>
                                        <td className="h-12 px-6 text-md border-t border-l first:border-l-0 border-slate-300 text-slate-800">{quantity}</td>
                                        <td className="h-12 px-6 text-md border-t border-l first:border-l-0 border-slate-300 text-slate-800">₹{price * quantity}</td>
                                        <td className="h-12 px-6 text-md border-t border-l first:border-l-0 border-slate-300 text-slate-800">{order.status}</td>
                                        <td className="h-12 px-6 text-md border-t border-l first:border-l-0 border-slate-300 text-slate-800">{order.addressInfo.name}</td>
                                        <td className="h-12 px-6 text-md border-t border-l first:border-l-0 border-slate-300 text-slate-800">{order.addressInfo.address}</td>
                                        <td className="h-12 px-6 text-md border-t border-l first:border-l-0 border-slate-300 text-slate-800">{order.addressInfo.pincode}</td>
                                        <td className="h-12 px-6 text-md border-t border-l first:border-l-0 border-slate-300 text-slate-800">{order.addressInfo.mobileNumber}</td>
                                        <td className="h-12 px-6 text-md border-t border-l first:border-l-0 border-slate-300 text-slate-800">{order.email}</td>
                                        <td className="h-12 px-6 text-md border-t border-l first:border-l-0 border-slate-300 text-slate-800">{order.date}</td>
                                        <td onClick={() => orderDelete(order.id)} className="h-12 px-6 text-md border-t border-l first:border-l-0 border-slate-300 text-red-500 cursor-pointer">Delete</td>
                                    </tr>
                                );
                            })
                        ))}
