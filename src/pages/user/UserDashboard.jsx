...
const UserDashboard = () => {
    ...
    const calculateTotalAmount = (order) => {
        ...
        order.cartItems.forEach(item => {
            total += parseFloat(item.price) * item.quantity; // Convert price to float if it's stored as a string
        });
        return total;
    };
    ...
    const formatDate = (timestamp) => {
        ...
        return date.toLocaleDateString('en-IN'); // Format date as per locale, 'en-IN' for day-month-year format
    };
