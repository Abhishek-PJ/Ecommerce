...
import { decrementQuantity, deleteFromCart, incrementQuantity, removeFromCart } from "../../redux/cartSlice";
...
const CartPage = () => {
  ...
  if (user) {
    ...
    // Add state for BuyNowModal open/close
    ...
    return (
        <>
                                        ...
                                        <div className="flex gap-4 mb-6">
                                            {user ? (
                                                userrole?.role?.toLowerCase() === "admin" ? (
                                                    <div className="w-full px-4 py-3 text-center text-white bg-gray-400 border border-transparent rounded-xl cursor-not-allowed">
            ...
            {/* Render BuyNowModal outside Layout to ensure proper centering */}
            {user && userrole?.role?.toLowerCase() !== "admin" && (
                <BuyNowModal
