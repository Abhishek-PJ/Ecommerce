                        ...
                        {Object.keys(categorizedProducts).map((category, idx) => (
                            <div key={idx} className="mb-8">
                                ...
                                <div className="relative flex items-center">
                                    <button
                                        className="absolute left-0 bg-gradient-to-r from-gray-600 to-gray-800 text-white font-bold py-2 px-4 rounded-full z-10 transform transition-transform hover:scale-110 focus:outline-none"
                                    ...
                                    >
                                        {categorizedProducts[category].map((item, index) => {
                                            const { id, title, price, productImageUrl } = item;
                                            return (
                                                <div key={index} className="min-w-[240px] sm:min-w-[320px]">
                                                    <div className="h-full border border-gray-200 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-transform duration-300 ease-in-out cursor-pointer">
                                                        <img
                                                            onClick={() => navigate(`/productinfo/${id}`)}
                                                            className="lg:h-80 h-52 w-full object-cover rounded-t-2xl transition-transform duration-300 ease-in-out hover:scale-105"
                                    ...
                                    <button
                                        className="absolute right-0 bg-gradient-to-r from-gray-600 to-gray-800 text-white font-bold py-2 px-4 rounded-full z-10 transform transition-transform hover:scale-110 focus:outline-none"
