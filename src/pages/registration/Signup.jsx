...
const Signup = () => {
    ...
    const userSignupFunction = async () => {
        ...
        if (!validatePassword(userSignup.password)) {
            toast.error("Password must contain at least 8 characters, including one uppercase letter, one lowercase letter, one number, and one special character.");
            return;
        }
                    ...
                    <div className="flex space-x-4">
                        <div className="flex items-center">
                            <input
                                ...
                                className="mr-2"
                            />
                            <label htmlFor="admin" className="text-sm font-medium text-gray-700">Admin</label>
                        </div>
                        <div className="flex items-center">
                            <input
                                type="radio"
